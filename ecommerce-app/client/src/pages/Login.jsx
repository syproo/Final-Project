...
const Login = () => {
  ...
  return (
    <div>
      ...
      <MainNav />
      <div className="font-fontApp relative w-full flex flex-col justify-center h-[70vh] overflow-hidden bg-gradient-to-b from-[#164990] to-[#276FB7]">
        <div className="">
          <img src="" alt="" />
        </div>
        <div className="w-96 p-6 mx-auto bg-white rounded-md shadow-md shadow-current lg:max-w-xl">
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <Link to={"/forgotpassword"}>
              <div className="text-md text-[#164990] underline">Forgot Password</div>
            </Link>
            <div className="mt-6">
